...
class UsuariosController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware('VerificarPermiso:creacion_usuarios_permisos', ['except' => ["verMisDatos", "guardarMisDatos"]]);
    }
    ...
    public function verMisDatos(Request $request){
        return view("dashboard.usuarios.mis-datos");
    }
    ...
    public function guardarMisDatos(Request $request){
        if($request->ajax()){
            ...
            return BD::actualiza(Auth::id(), "User", $data);
        }

jQuery(document).ready(function($) {
	_cargarTabla(
			...
			"/dashboard/obras-forma-obtencion-muestra/carga", // URL datos
			[
				{ data: "id", 		      width: "10%"},
...
function crear(){
  _mostrarFormulario("/dashboard/obras-forma-obtencion-muestra/create", //Url solicitud de datos
                      ...
                      "#form-obras-forma-obtencion-muestra", //ID del Formulario
...
function editar(id)
{
    _mostrarFormulario("/dashboard/obras-forma-obtencion-muestra/"+id+"/edit/", //Url solicitud de datos
                        "#modal-1", //Div que contendra el modal
                        "#modal-crear", //Nombre modal
                        "#nombre", //Elemento al que se le dara focus una vez cargado el modal
                        function(){
...
{
  _mostrarFormulario("/dashboard/obras-forma-obtencion-muestra/"+id+"/eliminar/", //Url solicitud de datos
                      "#modal-1", //Div que contendra el modal

...
function misDatos(){
  _mostrarFormulario("/dashboard/usuarios/mis-datos", //Url solicitud de datos
                    "#modal-3", //Div que contendra el modal
                    "#modal-mis-datos", //Nombre modal
                    "#name", //Elemento al que se le dara focus una vez cargado el modal
                    function(){
                    }, //Funcion para el success
                    "#form-mis-datos", //ID del Formulario
                    ...
                    function(){
                        _ocultarModal("#modal-mis-datos", function(){
                            location.reload();
                        });

        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-sm-6">
                    <div class="about-img">
                        <img src="{{ asset('img/landing/05.png') }}" alt="" class="img-fluid">
                        <img src="{{ asset('img/landing/09.png') }}" alt="" class="img-fluid mt-4">
                    </div>
                </div>
                <div class="col-lg-6 col-sm-6">
                    <div class="about-img mt-4 mt-lg-0">
                        <img src="{{ asset('img/landing/01.png') }}" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>

<div class="modal inmodal" id="modal-eliminar-terminos-relacionados" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content animated bounceInRight">
            ...
            {!! Form::open(['route' => ['dashboard.obras-tipo-bien-cultural.destruir-terminos-relacionados', $registro->id], 'method' => 'DELETE', 'id' => 'form-obras-tipo-bien-cultural-terminos-relacionados', 'class' => 'form-horizontal']) !!}

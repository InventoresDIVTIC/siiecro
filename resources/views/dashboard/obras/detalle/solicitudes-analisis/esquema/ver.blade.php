<div id="contenedor-imagnes-esquema">
	<div class="owl-carousel owl-theme" id="carrusel-imagenes-esquema">
	    @foreach ($imagenes_esquema as $imagen)
	        <div class="item p-r-sm p-l-sm" id="solicitudes-esquema-toma-muestras">
	        	<a href="{{ asset('img/obras/solicitudes-analisis-esquema/'.$imagen->imagen) }}" data-gallery="#galeria-solicitudes-esquema-toma-muestras">

<div id="contenedor-esquema-microfotografia">
	<div class="owl-carousel owl-theme" id="carrusel-esquema-microfotografia">
	    @foreach ($esquema_microfotografia as $imagen)
	        <div class="item p-r-sm p-l-sm" id="resultados-microfotografia">
	        	<a href="{{ asset('img/obras/resultados-analisis-esquema-microfotografia/'.$imagen->imagen) }}" data-gallery="#galeria-resultados-microfotografia">

<div class="modal inmodal" id="modal-crear-terminos-relacionados" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-content animated bounceInRight">
            ...
            @if ($registro == "[]")
                {!! Form::open(['route' => ['dashboard.obras-tipo-objeto.guardar-terminos-relacionados'], 'method' => 'POST', 'id' => 'form-obras-tipo-objeto-terminos-relacionados', 'class' => 'form-horizontal']) !!}
            @else
                {!! Form::open(['route' => ['dashboard.obras-tipo-objeto.actualizar-terminos-relacionados', $registro->id], 'method' => 'PUT', 'id' => 'form-obras-tipo-objeto-terminos-relacionados', 'class' => 'form-horizontal']) !!}
            @endif
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" name="tipo_objeto_id" id="tipo_objeto_id" value="">
            </div>
            {!! Form::close() !!}
        </div>
    </div>
